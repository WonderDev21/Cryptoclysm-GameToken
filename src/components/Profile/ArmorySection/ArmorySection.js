...
import FilterSection from "../../Armory/FilterSection";
...
const ArmorySection = () => {
	...
	const CustomSlide = ({ index, ...props }) => {
		return (
			<div {...props} className="armorySection__boxbattle">
				<img src={battleitem} alt="battleitem" />
			</div>
		);
	};
	return (
		<div className="armorySection">
			<PageTitle title="Armory" />
			<FilterSection />
			<div className="armorySection__sliderBox">
				<Slider {...settings}>
